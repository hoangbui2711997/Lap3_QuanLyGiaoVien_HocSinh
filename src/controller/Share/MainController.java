...
import controller.GiaoVienController.UpdateController;
...
//            AnchorPane.setLeftAnchor();
    ...
    private void actionBtn_Update() throws IOException, InterruptedException {
        if ("Giáo viên".equals(jfxCombobox.getValue())) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/GiaoVien/Update.fxml"));
            Parent root = loader.load();

            int pos = treeTableView.getSelectionModel().getSelectedIndex();
            GiaoVien oldGiaoVien = listGV.get(pos);
